"use strict";
let books = [{ id: 1, title: 'Harry Potter', author: 'J.K Rowliing', published: new Date(1997, 6, 26), available: true }, { id: 2, title: 'Hunger Games', author: 'Suzanne Collins', published: new Date(2008, 9, 14), available: true }];
